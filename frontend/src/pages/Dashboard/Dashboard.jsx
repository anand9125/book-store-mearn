...
import RevenueChart from './Revenu';
        ...
        <ul className="p-6 space-y-6">
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3  bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Annette Watson profile picture"/>
            </div>
            <span className="text-gray-600">Jeetu Pal</span>
            <span className="ml-auto font-semibold">9.3</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Calvin Steward profile picture"/>
            </div>
            <span className="text-gray-600">Yadi</span>
            <span className="ml-auto font-semibold">8.9</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Ralph Richards profile picture"/>
            </div>
            <span className="text-gray-600">Prince gupta</span>
            <span className="ml-auto font-semibold">8.7</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Bernard Murphy profile picture"/>
            </div>
            <span className="text-gray-600">Aditi Shukla</span>
            <span className="ml-auto font-semibold">8.2</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Arlene Robertson profile picture"/>
            </div>
            <span className="text-gray-600">Nishchay Kaushal</span>
            <span className="ml-auto font-semibold">8.2</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Jane Lane profile picture"/>
            </div>
            <span className="text-gray-600">Abhishek</span>
            <span className="ml-auto font-semibold">8.1</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg} className='h-10' alt="Pat Mckinney profile picture"/>
            </div>
            <span className="text-gray-600">Nikhil Solanky</span>
            <span className="ml-auto font-semibold">7.9</span>
          </li>
          <li className="flex items-center">
            <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
              <img src={avatarImg}  className="h-10" alt="Norman Walters profile picture"/>
            </div>
            <span className="text-gray-600">Ravi Chotu</span>
